...
'''
Pivot table - as an alternative to groupby for calculating grouped summary statistics, especially when you want to calculate multiple stats or pivot on multiple variables
Pivoting on one variable with .pivot_table()
'''
...
'''
fill in missing values and values with pivot tables
'''
